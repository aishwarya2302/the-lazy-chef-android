...
public class AdvancedSearchResults extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String endpoint = "https://api.spoonacular.com/recipes/search?cuisine=" + cuisineQuery + "&diet=" + dietQuery + "&excludeIngredients=" + excludeIngredientsQuery + "&intolerances=" + intolerancesQuery+ "&apiKey=fc6fef8c0bb04e27ad8da3843fef1602";
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull final Response response) throws IOException {
                ...
                if (response.isSuccessful()) {
                        ...
                        public void run() {
                            try {
                                ...
                                if (results.length() > 0) {
                                    ...
                                    advancedSearchResultsSubheading.setText("Search results for advanced search");
                    ...
                    loader.setVisibility(View.GONE);
                    advancedSearchResultsSubheading.setText("An unkown error occurred. Please contact the administrator.");
                }
            }
        });
